    ...
    >
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between border-b border-slate-800 px-8">
          ...
          <div className="min-w-[50px] rounded-full bg-purple-500/10 -translate-x-2">
        ...
        <div className="px-9 py-7">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="translate-y-2 text-sm uppercase tracking-[0.35em] text-purple-400 -translate-x-1">
                  Workspace
                </p>
            ...
            <div className="flex -space-x-3 gap-2 -translate-x-1">
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-purple-400 text-lg font-bold text-white">
                S
              </div>
          ...
          <div className="mt-6 grid grid-cols-3 gap-6">
            ...
            ">
              ...
              <Users
                size={28}
                className="text-purple-400 translate-x-2"
              />
            ...
            <div className="
              ...
              <Zap
                size={28}
                className="text-fuchsia-400 translate-x-2"
              />
            ...
            ">
              ...
              <CheckCircle2
                size={28}
                className="text-pink-400 translate-x-2"
              />
