...
const blobs = [
  {
    size: 420,
    className:
      "-left-44 -top-40 bg-blue-500/20 blur-[120px]",
    duration: 18,
  },
  {
    size: 360,
    className:
      "right-[-120px] top-1/3 bg-sky-500/20 blur-[120px]",
    duration: 22,
  },
  {
    size: 460,
    className:
      "bottom-[-180px] left-1/3 bg-indigo-600/20 blur-[140px]",
    duration: 20,
  },
];
...
export default function AnimatedBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden bg-[#07111F]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#153A74_0%,transparent_42%),radial-gradient(circle_at_bottom,#0A1D3E_0%,transparent_45%)]" />
